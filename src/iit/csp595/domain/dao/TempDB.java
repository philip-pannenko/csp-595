...
public final class TempDB {
  ...
  public static void initDB() {
    ...
    for (long i = 1; i < 4; i++) {
      usersUsername.put(users.get(i).getUsername(), users.get(i));
    }
