...
public final class Database {
  ...
  private static Map<Long, Product> initializeProducts() {
    ...
    result.put(++productSeqId, new Coffee(productSeqId, "Starbucks® Pike Place® Roast", "Our medium-roasted coffees are smooth, balanced and rich in flavor. Pike Place Roast is brewed fresh in our stores every day, and is inspired by our first store in Seattle's Pike Place Market. It's a smooth, well-rounded blend of Latin American coffees with subtly rich flavors of cocoa and toasted nuts – perfect for every day.", 11.95D, 16, sb, blend, latin_american));

    result.put(++productSeqId, new Coffee(productSeqId, "Starbucks® Dark Sumatra Roast", "Like the Sumatran tiger, this popular single-origin coffee makes its presence known.  It's big and bold with distinctive earthy aroma and lingering low notes.  The heavy, full body and concentrated herbal spice notes are hallmarks of great coffee from Sumatra and the pride of our most seasoned roasters.", 9.49D, 16, sb, blend, asia_pacific));
